...
//    // New function to update totalXP when game ends
//    const updateTotalXP = async (xp) => {
//     try {
//       //const email = "user@example.com"; // Replace this with the actual user's email
//       await axios.post(`http://localhost:5000/api/users/${user?.name}/addXP`, { xp });
...
//   // UseEffect to update totalXP when game ends
//   useEffect(() => {
//     if (isGameOver) {
//       updateTotalXP(score); // Update totalXP with the current score
//     }
//   }, [isGameOver, score]);
